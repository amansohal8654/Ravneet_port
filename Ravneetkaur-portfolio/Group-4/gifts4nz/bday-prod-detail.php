 ...
 {  
      ...
      {  
           ...
           {  
				...
				header('Location: bday-prod-detail.php');
           }  
      }  
      else  
      {  
...
<head>
    ...
    <meta name="description" content="Birthday gifts for NZ with Personal Message">
    <meta name="author" content="Birthday gifts for NZ with Personal Message">
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<a href="#slider-carousel" class="right control-carousel hidden-xs" data-slide="next">
							...
							<?php  
								...
								$query = "SELECT * FROM birthday_prod where id='".$_GET["id"]."'ORDER BY id ASC";  
