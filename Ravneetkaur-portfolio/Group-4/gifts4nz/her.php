...
<head>
    ...
    <meta name="description" content="Her gifts for NZ with Personal Message">
    <meta name="author" content="Her gifts for NZ with Personal Message">
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li><a href="her.php" class="active">Her</a></li>
			...
			<div class="row">
				...
				<div class="container">
					<div class="col-md-12"><!--features_items-->
						<h2 class="title" style="margin-left:400px;">Featured Items</h2>
						<?php  
								$query = "SELECT * FROM her_prod ";  
								...
								<div class="single-products">
										...
										<div class="product-overlay">
											...
											<p ><?php e//cho $row["name"]; ?> </p>-->
												...
												<a href="her-prod-detail.php?action=add&id=<?php echo $row["id"]; ?>" class="btn btn-default add-to-cart">View Details</a>
