...
<head>
    ...
    <meta name="description" content="Wedding gifts for NZ with Personal Message">
    <meta name="author" content="Wedding gifts for NZ with Personal Message">
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<a href="#slider-carousel" class="right control-carousel hidden-xs" data-slide="next">
							...
							<?php  
								...
								$query = "SELECT * FROM wedding_prod where id='".$_GET["id"]."'ORDER BY id ASC";  
