					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li><a href="his.php" class="active">His</a></li>
			...
			<div class="row">
				...
				<div class="container">
					<div class="col-md-12"><!--features_items-->
						...
						<?php  
								$query = "SELECT * FROM his_prod ORDER BY id ASC";  
								...
								<div class="single-products">
										...
										<div class="product-overlay">
											...
											<p ><?php e//cho $row["name"]; ?> </p>-->
												...
												<a href="prod-detail.php?action=add&id=<?php echo $row["id"]; ?>" class="btn btn-default add-to-cart">View Details</a>
