...
<head>
    ...
    <meta name="description" content="Celebration gifts for NZ with Personal Message">
    <meta name="author" content="Celebration for NZ with Personal Message">
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<a href="#slider-carousel" class="right control-carousel hidden-xs" data-slide="next">
							...
							<?php  
								...
								$query = "SELECT * FROM celebration_prod where id='".$_GET["id"]."'ORDER BY id ASC";  
